...
## Project Structure
    ...
    ├── jkozel_cb_test_env_40747  # Django project configurations
...
1. Clone this repo and `cd jkozel_cb_test_env_40747`
...
2. Clone this repo and `cd jkozel_cb_test_env_40747`
