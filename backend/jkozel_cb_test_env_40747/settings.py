"""
Django settings for jkozel_cb_test_env_40747 project.
...
ROOT_URLCONF = 'jkozel_cb_test_env_40747.urls'
...
WSGI_APPLICATION = 'jkozel_cb_test_env_40747.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jkozel_cb_test_env_40747 API",
    "DESCRIPTION": "API documentation for jkozel_cb_test_env_40747 App",
    "VERSION": "v1",
}
